...
<h2 align="center" style="font-family:'typo'; color:#000066">FEEDBACK/ASK A QUERY</h2>
...
<div class="form-group"> 
<textarea rows="5" cols="8" name="feedback" class="form-control" placeholder="feedback"></textarea>
</div>
